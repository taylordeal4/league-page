...
<div class="constitution">
   ...
   <h3 class="noUnderscore clickable" on:click={() => goToSection(ten)}>Article 10: Offenses</h3>
    ...
    <p>Any action of the Commissioner taken pursuant to this Article, regardless of whether or not it is specifically designated as “reviewable”, may be overturned under the following process: </p>
        <p>Team managers interested in the outcome of the Commissioner’s decision (i.e., the team that would receive the direct benefit of an overturned vote and any other team(s) directly involved in the challenged transaction and/or act) are deemed interested parties and are not eligible to participate in a vote to overturn that decision. </p>
            <p>For further clarity, each team’s interest in the general competitiveness of each other team shall not constitute an “interest” in the outcome of a decision for the purposes of subsection (a).</p>
        <p>One-third of team managers eligible to cast a vote to overturn must agree to a petition for reconsideration or a vote upon the challenged decision. That petition must be made within one week of the formal posting of the challenged decision on the league chat of the Sleeper app, by tagging the Commissioner. </p>
            <p>For further clarity, without such a petition being made, there shall be no review of a Commissioner’s decision.</p>
        <p>If the Commissioner does not reconsider the decision, a vote shall be held.</p>
        <p>The Commissioner and all interested parties may make such representations to the team managers as they may wish in support of their preferred outcome. </p>
        <p>The decision of the Commissioner may be overturned only upon a two-thirds majority vote of eligible team managers.</p>
        <p>If such a majority is not achieved, the decision of the Commissioner stands. </p>
        <p>If such a majority is achieved, the decision of the Commissioner is vacated.  </p>
            <p>For further clarity, this shall not preclude further action by the Commissioner upon the same challenged act. </p>
