...
<a href="https://logwork.com/countdown-fzwj" class="countdown-timer" data-timezone="America/Chicago" data-textcolor="#ffffff" data-date="2024-08-25 13:00">Countdown to the 2024 Draft</a>
...
export const managers = [
  {
      ...
      "name": "Robby",
      "location": "IA", // (optional)
      "bio": "He/Him/His; Father, Husband, Gamer, Perfectionist, Secular Humanist, Agnostic Atheist, Moral Relativist, Philosophical Absurdist, Democratic Socialist, Libra (obvi), Aspiring Woodworker, DSM Menace Supporter, ADHD & Sleep Apnea Haver, Former Evangelical & Libertarian 🙏",
    ...
    },
    {
      ...
      "name": "Jeremiah",
      "location": "IA", // (optional)
      "bio": "Tenured Fantasy Football Owner",
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Take my time drafting.",
      "tradingScale": 3, // 1 - 10
    ...
    },
    {
      ...
      "mode": "Rebuild", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Jeremiah", // Can be anything (usually your rival's name)
        link: 3, // manager array number within this array, or null to link back to all managers page
        image: "/managers/jeremiah.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      "favoritePlayer": 4666, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Draft players with cool names.",
      "tradingScale": 1, // 1 - 10
      "preferredContact": "Carrier Pigeon", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
      {
      ...
      "favoritePlayer": 2036, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
    ...
    },
    {
      ...
      "favoritePlayer": 7437, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
